...
var Module = typeof raylib !== 'undefined' ? raylib : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ma_device_process_pcm_frames_capture__webaudio')) {
        Object.defineProperty(Module['ready'], '_ma_device_process_pcm_frames_capture__webaudio', { configurable: true, get: function() { abort('You are getting _ma_device_process_pcm_frames_capture__webaudio on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ma_device_process_pcm_frames_capture__webaudio', { configurable: true, set: function() { abort('You are setting _ma_device_process_pcm_frames_capture__webaudio on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ma_device_process_pcm_frames_playback__webaudio')) {
        Object.defineProperty(Module['ready'], '_ma_device_process_pcm_frames_playback__webaudio', { configurable: true, get: function() { abort('You are getting _ma_device_process_pcm_frames_playback__webaudio on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ma_device_process_pcm_frames_playback__webaudio', { configurable: true, set: function() { abort('You are setting _ma_device_process_pcm_frames_playback__webaudio on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
